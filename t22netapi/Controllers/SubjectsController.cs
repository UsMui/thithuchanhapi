...
namespace t22netapi.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public SubjectsController(ThiThucHanhContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Subjects != null ? 
                          ...
                          Problem("Entity set 'ThiThucHanhContext.Subjects'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ThiThucHanhContext.Subjects'  is null.");
            }
            var subject = await _context.Subjects.FindAsync(id);
            if (subject != null)
            {
