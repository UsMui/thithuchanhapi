...
namespace t22netapi.Controllers
{
    public class ClassroomsController : Controller
    {
        ...
        public ClassroomsController(ThiThucHanhContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Classrooms != null ? 
                          ...
                          Problem("Entity set 'ThiThucHanhContext.Classrooms'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ThiThucHanhContext.Classrooms'  is null.");
            }
            var classroom = await _context.Classrooms.FindAsync(id);
            if (classroom != null)
            {
