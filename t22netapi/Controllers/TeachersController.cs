...
namespace t22netapi.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public TeachersController(ThiThucHanhContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Teachers != null ? 
                          ...
                          Problem("Entity set 'ThiThucHanhContext.Teachers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ThiThucHanhContext.Teachers'  is null.");
            }
            var teacher = await _context.Teachers.FindAsync(id);
            if (teacher != null)
            {
