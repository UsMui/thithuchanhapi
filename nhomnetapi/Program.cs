...
using nhomnetapi.Configuration;
...
nhomnetapi.Entities.T22netContext.connectionString = builder.Configuration.GetConnectionString("nhomapi");

builder.Services.AddDbContext<nhomnetapi.Entities.T22netContext>(
    options => options.UseSqlServer(builder.Configuration.GetConnectionString("nhomapi"))
);
